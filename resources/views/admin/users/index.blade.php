...
@endif
    ...
    <form action="" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="text" name="password" class="form-control" {{ old('password', str_random()) }}>
      </div>
      <div class="form-group">
        <button type="submit" value="button" class="btn btn-primary">Registrar Usuario</button>
      </div>
    </form>
